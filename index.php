...
<head>
  ...
  <link rel="preload" data-rocket-preload as="image"
    href="wp-content/uploads/logo-4.png"
    imagesrcset="wp-content/uploads/logo-4.png 996w, wp-content/uploads/logo-4-300x66.png 300w, wp-content/uploads/logo-4-768x168.png 768w"
  ...
  <link rel="canonical" href="https://www.jobkaka.com/" />
  <link rel="next" href="https://www.jobkaka.com/page/2/" />
  <meta property="og:locale" content="en_US" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Job Kaka" />
  <meta property="og:description" content="Navigating Careers, Creating Futures." />
  <meta property="og:url" content="https://www.jobkaka.com/" />
  ...
  <link rel='stylesheet' id='wp-rest-filter-css'
    href='wp-content/plugins/wp-rest-filter/public/css/wp-rest-filter-public.css?ver=1.4.3' type='text/css'
    media='all' />
  <link rel='stylesheet' id='dashicons-css' href='wp-includes/css/dashicons.min.css?ver=6.7.2' type='text/css'
    media='all' />
  <script type="text/javascript" src="wp-includes/js/jquery/jquery.min.js?ver=3.7.1" id="jquery-core-js"></script>
  <script type="text/javascript" src="wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.1"
    id="jquery-migrate-js"></script>
  <script type="text/javascript" src="wp-content/plugins/wp-rest-filter/public/js/wp-rest-filter-public.js?ver=1.4.3"
    id="wp-rest-filter-js"></script>
...
<body class="home blog wp-custom-logo header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-hidden">
  <?php
        ...
        <main class="content">
          <div class="home-search">
              ...
              <center>
                <div class="kaka-search">
                  <form class="search-form" method="get" action="https://www.jobkaka.com/" role="search"><label
                      ...
                      aria-label="Search"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        class="search-icon">
                        <path
            ...
            <div class="sort-kaka">
              ...
              <?php
                $sql = "SELECT q_title FROM tbl_qualifications WHERE home_status = 1 ORDER BY q_id ASC";
                ...
                if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    ...
                    $qualifications[] = '<a href="https://www.jobkaka.com/?s=' . $slug . '">' . htmlspecialchars($title) . ' Jobs</a>';
                  }
              ...
              <?php
                ...
                if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    ...
                    $slug = urlencode(str_replace('-', ' ', $row['category_slug'])); // turn slug to "Railway Jobs" etc.
                    $links[] = '<a href="https://www.jobkaka.com/?s=' . $slug . '">' . htmlspecialchars($title) . '</a>';
                  }
            ...
            <!-- <div class="sort-kaka"><b>Search by Qualification</b> <br /> <a
             ...
             <div class="sort-kaka"><b>Search by Type</b> <br /> <a
                ...
                href="https://www.jobkaka.com/?s=Postal+Jobs">Postal Jobs</a></div> -->

                <!-- <div class="kaka-main-heading">
              <center>
                <h1>Top Selected Jobs</h1>
              </center>
            </div>
            <div class="trending-list-cl">
              <div class="articles">
                <a class="content_link" href="https://www.jobkaka.com/cspdcl-apprentice-post/">
                  <div class="entry-title">CSPDCL Recruitment 2025 &#8211; Apprentice &#8211; 160 Vacancies
                  </div>
                  <div class="bfooter">
                ...
                <a class="content_link" href="https://www.jobkaka.com/kgmu-nursing-officer-post/">
                  <div class="entry-title">KGMU Recruitment 2025 &#8211; Nursing Officer &#8211; 733 Vacancies
                  </div>
                  <div class="bfooter">
                    <div class="entry-job-liner-1">
                      <span class="entry-job-date">Updated on </span>
                ...
                <a class="content_link" href="https://www.jobkaka.com/cg-vyapam-post/">
                  <div class="entry-title">CG Vyapam Recruitment 2025 &#8211; सहायक विकास विस्तार अधिकारी (एडीओ) &#8211;
                    200 Vacancies
                  </div>
                  <div class="bfooter">
                    <div class="entry-job-liner-1">
  ...
  <script type="text/javascript" src="wp-content/themes/genesis-sample/js/genesis-sample.js?ver=2.6.0"
    id="genesis-sample-js"></script>
